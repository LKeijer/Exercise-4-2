    ...
    public class Grade
    {
        ...
        public string AssessmentDate
        {
            ...
            set
            {
                ...
                if(DateTime.TryParse(value, out assessmentDate))
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException("The date can't be in the future");
                    }
                    else
                    {
                ...
                {
                    throw new ArgumentException("AssessmentDate, The Assessment date is in the wrong format");
                }
            }
        }
        ...
        public string SubjectName
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("The subject entered is not valid");
                }
            }
        }
        ...
        public string Assessment
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Assessment","This is not a valid mark.");
                }
            }
        }
